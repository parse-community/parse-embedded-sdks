 ...
 *
 *  DigiCertHighAssuranceEVRootCA.der was generated by exporting the
 *  DigiCert High Assurance EV Root CA certificate from Firefox.
 *
 *  DigiCert High Assurance EV Root CA certificate is the root
 *  certificate that parse.com certificate is signed by.
 */
// DigiCertHighAssuranceEVRootCA.der was generated by exporting the
// DigiCert High Assurance EV Root CA certificate from Firefox
static unsigned char DigiCertHighAssuranceEVRootCA_der[] = {
